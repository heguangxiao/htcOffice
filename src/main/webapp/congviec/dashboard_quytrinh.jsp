	    ...
	    <div class="container-fluid" >     
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent" style="float: left">
	           <ul class="nav navbar-nav mr-auto">
	                <li class="nav-item">
	                    <a class="nav-link" href="<c:url value='/home3/dashboard_congviec'/>">Công việc</a>
	                </li>
	                <li class="nav-item">
	                    <a style="border-bottom: 4px solid #6495ED;color:#6495ED" class="nav-link" href="<c:url value='/home3/dashboard_quytrinh'/>">Quy trình</a>
	                </li>
