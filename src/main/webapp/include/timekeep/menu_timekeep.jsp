    ...
    <ul class="navbar-nav mr-auto">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-content">
                <a class="dropdown-item" href="<c:url value="/timekeep-attendance-assign/add"/>">
                    Phân ca
                </a> 
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav mr-auto">
                <li class="nav-item dropdown bg-light" style="margin-left: 10px">
                    <a style="color: blue;font-size:  15px;">Bảng chấm công từ <span id="stdate"></span> đến <span id="enddate"></span> </a><br>
        ...
        <ul class="navbar-nav" style="float: right">         
            ...
            <li class="nav-item dropdown bg-light" style="margin-left: 10px">
                <div data-toggle="modal" data-target="#exampleModal1">
                    <a class="nav-link nav-profile-text  bg-light dropbtn" href="#">
                        &nbsp;&nbsp;<i class="mdi mdi-check" style=" margin-bottom: 10px"  >
                        </i>
                        <div style="font-size: 12px">Chốt công</div>
                    </a>
                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: red">
                                <h5 class="modal-title" id="exampleModalLabel">Xác nhận chốt công</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <span>Bạn có muốn thực hiện tác vụ này không?<span style="color: red">*</span></span>
                            </div>
            ...
            <li class="nav-item dropdown bg-light" style="margin-left: 10px">
                <div data-toggle="modal" data-target="#exampleModal2"> 
                    <a class="nav-link nav-profile-text  bg-light dropbtn" href="#">
                        &nbsp;&nbsp;<i class="mdi mdi-lock" style=" margin-bottom: 10px" >
                        </i>
                        <div style="font-size: 12px">Chốt đơn</div>
                    </a>
                </div>
                ...
                <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: red">
                                <h5 class="modal-title" id="exampleModalLabel">Xác nhận chốt đơn</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            ...
            <li class="nav-item dropdown bg-light" style="margin-left: 10px">
                <div data-toggle="modal" data-target="#exampleModal3">
                    <a class="nav-link nav-profile-text  bg-light dropbtn">
                        &nbsp;&nbsp;<i class="mdi mdi-file-import" style=" margin-bottom: 10px"  >
                        </i>
                ...
                <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: red">
                                <h5 class="modal-title" id="exampleModalLabel">Xác nhận import</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            ...
            <li class="nav-item dropdown bg-light" style="margin-left: 10px">
                <a class="nav-link nav-profile-text  bg-light dropbtn" href="#">
                    &nbsp;&nbsp;<i class="mdi mdi-account-plus" style=" margin-bottom: 10px">
                    </i>
                    <div style="font-size: 12px">Thêm người</div>
                </a>
                <div class="dropdown-menu-right dropdown-content"  >
