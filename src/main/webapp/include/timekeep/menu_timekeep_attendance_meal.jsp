    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
            <a class="nav-link nav-profile-text" style="color: black; margin-top: 5px;margin-bottom: 5px">
                Bảng chấm công từ <span id="stdate"></span> đến <span id="enddate"></span> </a><br>
            </a>
        </li>
    </ul>
    ...
    <div class="container-fluid" >     
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Công ăn theo ca</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Công ăn làm thêm</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Công ăn tổng hợp</a>
                </li>
            </ul>
        </div>
