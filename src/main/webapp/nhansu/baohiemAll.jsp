        ...
        <tbody>
            ...
            <tr>
                <td class="active">
                    <input type="checkbox" class="select-item checkbox" name="select-item" value="1003" />
               		...
               		<td class="manv">60</td>
	                <td class="hoten">lê van hiếu</td>
	                <td class="phongban">bảo kê</td>
	                <td class="vitricongviec">tổ trưởng</td>
	                <td class="chucvu">tốt</td>
	                <td class="soso">20</td>
	                <td class="sothe">201</td>
	                <td class="batdaudong">1999</td>
	                <td class="mucdongbaohiem">200 tr</td>
	                <td class="ctdong">2 tr</td>
	                <td class="nldnop">1 tr</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="active">
	                ...
	                <td class="sothe">1999</td>
	                <td class="batdaudong">1999</td>
	                <td class="mucdongbaohiem">200000 k</td>
	                <td class="ctdong">100 tr</td>
	                <td class="nldnop">200 tr</td>
            </tr>
        </tbody>
    </table>
