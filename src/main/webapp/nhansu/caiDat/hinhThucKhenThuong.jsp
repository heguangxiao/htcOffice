        ...
        <div class="modal-content" >
            <form action="<c:url value='/'/>" >
                ...
                <div class="modal-header" style="background: #6495ED">
                    <label class="modal-title" style="color:white">SỬA HÌNH THỨC KHEN THƯỞNG</label>
				...
				<div style="width: 480px;margin-left: 10px;">
					...
					<br>
					<input class="form-control" type="text" value="Tăng lương" style="width: 480px;background: #D8D8D8">
					
					<div style=" margin-top: 10px">
						<label for="validationServer013">Hình thức cha</label>
						<select class="form-control" style="width: 480px;background: #D8D8D8">
						...
						<div style="margin-bottom: 10px;">
							<div class="input-group" style="margin-left: 0px; width: 480px;">
								<input type="text" class="form-control"
									value="Hình thức khen thưởng tăng lương">
        ...
        <div class="modal-content" >
            <form action="<c:url value='/'/>" >
				...
				<div style="width: 480px;margin-left: 10px;">
					<label style="font-family:Arial;margin-top: 10px">Tên hình thức *</label>
					<br>
					<input class="form-control" type="text" placeholder="Nhập tên hình thức" style="width: 480px;">
...
$(document).ready(function() {
    ...
    document.getElementById("htkt").style.backgroundColor = "#A1EDED";
