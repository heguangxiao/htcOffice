		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent" style="float: left">
            <ul class="nav navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    ...
                    <a class="nav-link" href="<c:url value='/tatCaKyDanhGia'/>" >Tất cả</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/banDanhGia'/>" >Bạn đánh giá</a>	
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/danhGiaBan'/>" style="border-bottom: 4px solid #6495ED;color:#6495ED">Đánh giá bạn</a>
                </li>
