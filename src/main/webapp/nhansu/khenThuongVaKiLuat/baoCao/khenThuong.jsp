        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="float: left">
            <ul class="nav navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="<c:url value='/khenThuong'/>" style="border-bottom: 4px solid #6495ED;color:#6495ED">Khen thưởng</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/kyLuatLaoDong'/>">Kỷ luật lao động</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="<c:url value='/kyLuatNoiBo'/>">Kỷ luật nội bộ</a>
                </li>
