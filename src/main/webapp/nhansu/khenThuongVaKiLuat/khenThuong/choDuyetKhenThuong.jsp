    ...
    <div class="container-fluid" >     
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="float: left">
            <ul class="nav navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/choDuyetKhenThuong'/>" style="border-bottom: 4px solid #6495ED;color:#6495ED">Chờ duyệt</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="<c:url value='/daDuyetKhenThuong'/>">Đã duyệt</a>
                </li>
                <li class="nav-item">
