        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="float: left">
            <ul class="nav navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="<c:url value='/tatCaKhenThuong'/>" >Tất cả</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/choDuyetKhenThuong'/>" >Chờ duyệt</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="<c:url value='/daDuyetKhenThuong'/>" style="border-bottom: 4px solid #6495ED;color:#6495ED">Đã duyệt</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/khongDuyetKhenThuong'/>">Không duyệt</a>
                </li>
