    ...
    <div class="container-fluid" >     
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="float: left">
            <ul class="nav navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/choDuyetKLLD'/>" style="border-bottom: 4px solid #6495ED;color:#6495ED">Chờ duyệt</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="<c:url value='/daDuyetKLLD'/>">Đã duyệt</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/khongDuyetKLLD'/>">Không duyệt</a>
                </li>
