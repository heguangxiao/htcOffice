    ...
    <table class="table table-hover table-striped ">
        <thead>
            <tr>
                ...
                <th class="success">Tên kỳ đánh giá</th>
                <th class="warning">Thời gian</th>
                <th class="danger">Trạng thái</th>
                <th class="danger">Đối tượng nhận đánh giá</th>
                <th class="danger">Người chấm điểm</th>
